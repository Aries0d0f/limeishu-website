										...
										<tr>
											...
											<td width="560">
												...
												<TABLE id="Table5" cellSpacing="1" cellPadding="5" width="100%" bgColor="#999999" border="0">
                                                  <TR bgColor="#669999">
                                                    <TD align="center" width="32%"><FONT color="#ffffff">主題</FONT></TD>
                                                    <TD align="center" width="14%"><FONT color="#ffffff">發表人</FONT></TD>
                                                    <TD align="center" width="20%" height="12"><FONT color="#ffffff">張貼時間</FONT></TD>
                                                  </TR>
												  <%=list%>
                                                </TABLE>												<!--主題文章start -->
