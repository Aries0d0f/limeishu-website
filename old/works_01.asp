...
while not rs.eof 
	...
	PhotoList=PhotoList & "<td align=left width=12% ><font  size=2>  <a href='works_01.asp?c_Photo=" & rs("c_Photo") & "' broder=0 > <img src='db/" & rs("c_FileName") & "' height=60  border='0' ></a></font></td>" & chr(13)	
...
<HTML>
	<HEAD>
		...
		.style2 { FONT-WEIGHT: bold; COLOR: #6633cc }
		</style>
											...
											<td vAlign="middle" width="674">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														...
														<td vAlign="bottom" width="53%"><strong><font color="#330033">畫作作品</font></strong></td>
												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<tr>
														<td height="6"><table border="0" align="left" cellpadding="0" cellspacing="0">
                                                          <tr>
                                                            <td width="1%">&nbsp;</td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1912"><img src="images/<%if c_Year=1912 then response.write "banner_b2_03.gif" else response.write "banner_b1_03.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1922"><img src="images/<%if c_Year=1922 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1932"><img src="images/<%if c_Year=1932 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1942"><img src="images/<%if c_Year=1942 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1952"><img src="images/<%if c_Year=1952 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1962"><img src="images/<%if c_Year=1962 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                            <td><a href="works_01.asp?c_type=1&c_Year=1972"><img src="images/<%if c_Year=1972 then response.write "banner_b2_03.gif" else response.write "banner_b1_05.gif" %>" width="78" height="12" border="0"></a></td>
                                                          </tr>
                                                        </table></td>
													</tr>
													<tr>
